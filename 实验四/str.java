...
String str = "汉皇重色思倾国御宇多年求不得杨家有女初长成养在"
		...
		+ "曲九重城阙烟尘生千乘万骑西南行翠华摇摇行复止西出都"
		+ "门百余里六军不发无奈何宛转蛾眉马前死花钿委地无人收"
		+ "翠翘金雀玉搔头君王掩面救不得回看血泪相和流黄埃散漫"
		+ "风萧索云栈萦纡登剑阁峨嵋山下少人行旌旗无光日色薄蜀"
		+ "江水碧蜀山青圣主朝朝暮暮情<未完，待续>";
...
if (i % 2 == 0 )
	...
	System.out.println("……");
 	...
 	System.err.println("出现错误."+e.toString());
}
...
private static void countString(String str,String s) {
   ...
   System.out.println(s+"共出现了"+count+"次");
 }
}
